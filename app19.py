...
<div style="text-align: center; font-family: monospace;">
    <!-- 画面サイズを幅 {canvas_width}px、高さ {canvas_height}px に拡大 -->
...
// ブロック（防衛レーザー壁）※画面幅に合わせてサイズを自動計算
let brickRowCount = 5;
let brickColumnCount = 7; // 列を1つ増やして密にしました
let brickPadding = 12;
let brickOffsetTop = 50;
let brickOffsetLeft = 25;
// 利用可能な横幅からブロック1個あたりの幅を計算
